...
export async function construirOpenApi(): Promise<JsonSchema> {
  ...
  return {
    ...
    tags: [
      ...
      { name: 'surgeries', description: 'Cirugias programadas (agregados de analitica)' },
      { name: 'health', description: 'Sondas de salud' },
      { name: 'patients', description: 'Pacientes (datos HIS, sin PII)' },
      { name: 'admissions', description: 'Ingresos hospitalarios (datos HIS)' },
      { name: 'triages', description: 'Triages de urgencias (datos HIS)' },
      { name: 'service-records', description: 'Registros de servicio prestado (datos HIS)' },
      { name: 'procedures', description: 'Catalogo de procedimientos (CUPS)' },
      { name: 'surgery-schedules', description: 'Programacion de cirugias (CRUD, datos HIS)' },
      { name: 'imports', description: 'Carga de archivos CSV del HIS por API' },
    ],
    paths,
  };
}
